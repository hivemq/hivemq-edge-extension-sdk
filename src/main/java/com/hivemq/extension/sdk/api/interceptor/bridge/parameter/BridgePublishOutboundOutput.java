...
/**
 * This is the output parameter of any {@link BridgePublishOutboundInterceptor} providing methods to define the outcome of
...
public interface BridgePublishOutboundOutput extends AsyncOutput<BridgePublishOutboundOutput> {
     ...
     * @since Edge 2023.1
     */
    @NotNull Async<BridgePublishOutboundOutput> async(@NotNull Duration timeout, @NotNull TimeoutFallback timeoutFallback);
}
