...
/**
 * This is the output parameter of any {@link BridgePublishInboundInterceptor} providing methods to define the outcome
 * of PUBLISH interception.
 * <p>
 * It can be used to
 * <ul>
 ...
 */
@DoNotImplement
public interface BridgePublishInboundOutput extends AsyncOutput<BridgePublishInboundOutput> {
     ...
     * @since Edge 2023.1
     */
    @NotNull Async<BridgePublishInboundOutput> async(
            @NotNull Duration timeout, @NotNull TimeoutFallback timeoutFallback);
