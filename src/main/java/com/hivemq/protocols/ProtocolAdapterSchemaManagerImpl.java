 ...
 */
public class ProtocolAdapterSchemaManagerImpl implements ProtocolAdapterSchemaManager {
    ...
    public ProtocolAdapterSchemaManagerImpl(@NotNull final ObjectMapper objectMapper,
    ...
    public List<ProtocolAdapterValidationFailure> validateJsonDocument(@NotNull final byte[] jsonDocument) throws IOException {
        ...
        return schema.validate(node).stream().
                map(ProtocolAdapterSchemaManagerImpl::convertMessage).
