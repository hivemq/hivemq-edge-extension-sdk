...
image:https://img.shields.io/maven-central/v/com.hivemq/hivemq-edge-extension-sdk?style=for-the-badge["Maven Central",link="https://central.sonatype.com/artifact/com.hivemq/hivemq-edge-extension-sdk"]
